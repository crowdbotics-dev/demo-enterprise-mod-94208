"""
Django settings for demo_enterprise_mod_94208 project.
...
ROOT_URLCONF = 'demo_enterprise_mod_94208.urls'
...
WSGI_APPLICATION = 'demo_enterprise_mod_94208.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_enterprise_mod_94208 API",
    "DESCRIPTION": "API documentation for demo_enterprise_mod_94208 App",
    "VERSION": "v1",
}
