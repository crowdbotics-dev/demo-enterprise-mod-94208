...
## Project Structure
    ...
    ├── demo_enterprise_mod_94208  # Django project configurations
...
1. Clone this repo and `cd demo_enterprise_mod_94208`
...
2. Clone this repo and `cd demo_enterprise_mod_94208`
